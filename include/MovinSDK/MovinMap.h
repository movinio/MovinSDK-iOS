...
/**
 * @brief Gets the description of this map.
 */
@property(readonly, nonnull) NSString* descriptionText;
/**
 * @brief Gets the lowest floor number of this map.
 */
@property(readonly) double lowestFloorNumber;
/**
 * @brief Gets the highest floor number of this map.
 */
@property(readonly) double highestFloorNumber;

/**
 * @brief Gets an dictionary filled with the sub types available in this map.
 */
@property(readonly, nonnull) NSDictionary<NSString*, MovinEntitySubType*>* subTypes;
/**
 * @brief Gets whether or not the map is currently downloading map data
 */
@property(readonly) BOOL isDownloadingMapData;
/**
 * @brief Gets whether or not the map is currently downloading beacon data
 */
@property(readonly) BOOL isDownloadingBeaconData;

/**
 * @brief Initializes a new MovinMap object with the specified JSON data.
...
/**
 * @brief Attempts to create a positioning engine. If it succeeds, a MovinPositioningEngine is returned, otherwise
...
/**
 * @brief Attempts to download the beacon data. After downloading the data the callback, if present, will be invoked.
...
/**
 * @brief Attempts to download the map data. After downloading the data, the callback, if present, will be invoked.
 * If the data has already been loaded the callback will be invoked immediately.
 * @param callback The callback to invoke once the downloading has been completed.
 */
...
/**
 * @brief Attempts to download the tile manifest. After downloading the file, the callback, if present, will be
...
/**
 * @brief Caches all image data associated with the sub types, map data and beacons.
 */
- (void)downloadImageData;

/**
 * @brief Gets all beacons available in this map. The result is returned using a callback.
...
/**
 * @brief Gets all beacon groups available in this map. The result is returned using a callback.
 * @param callback The callback to invoke once the result is ready.
 */
- (void)getBeaconGroupsWithCallback:(nonnull BeaconGroupsCallback)callback;

/**
 * @brief Gets all beacons in this map within the specified shape and floor. The result is returned using a callback.
...
/**
 * @brief Gets all entities available in this map. The result is returned using a callback.
 * @param callback The callback to invoke once the result is ready.
 */
- (void)getEntitiesWithCallback:(nonnull EntitiesCallback)callback;

/**
 * @brief Gets all entities in this map within the specified shape and floor. The result is returned using a callback.
 * @param shape The shape in which to search.
 * @param floor The floor on which to search.
 * @param callback The callback to invoke once the result is ready.
 */
...
/**
 * @brief Gets all buildings available in this map. The result is returned using a callback.
 * @param callback The callback to invoke once the result is ready.
 */
- (void)getBuildingsWithCallback:(nonnull BuildingsCallback)callback;

/**
 * @brief Gets all buildings in this map within the specified shape. The result is returned using a callback.
 * @param shape The shape in which to search.
 * @param callback The callback to invoke once the result is ready.
 */
...
/**
 * @brief Gets the tile manifest for this map. The result is returned using a callback.
 * @param callback The callback to invoke once the result is ready.
 */
